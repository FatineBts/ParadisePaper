...
Ecran::Ecran():_win(NULL),_renderer(NULL),_img(NULL),_l(935),_h(520),_screen_name("Paradise Paper"),_PATH("/Users/fatine/Desktop/Cpp/Cpp/IMG/paradise.jpeg"){} // constructeur par défaut
