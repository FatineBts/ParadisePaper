...
void Reponses::initialisation_reponses_ecrites()
{
    ...
    _liste_ecrite_rep[11]="A";
    _liste_ecrite_rep[12]="A";
    _liste_ecrite_rep[13]="A";
    _liste_ecrite_rep[14]="A";
    _liste_ecrite_rep[15]="A";
    _liste_ecrite_rep[16]="A";
    _liste_ecrite_rep[17]="A";
    _liste_ecrite_rep[18]="A";
    _liste_ecrite_rep[19]="A";
    _liste_ecrite_rep[20]="A";
    _liste_ecrite_rep[21]="A";
    _liste_ecrite_rep[22]="A";
    _liste_ecrite_rep[23]="A";
    _liste_ecrite_rep[24]="A";
    _liste_ecrite_rep[25]="A";
    _liste_ecrite_rep[26]="A";
    _liste_ecrite_rep[27]="A";
    _liste_ecrite_rep[28]="A";
...
std::string Reponses::recuperation_reponses(int numero_question, int mode)
{
    ...
    rep=_liste_ecrite_rep[numero_question]; //récupère la réponse
