...
#include <iostream>
#include <time.h> //Ne pas oublier d'inclure le fichier time.h pour le rand
...
public:
    ...
    std::string get_page(){return _page;} //retourne le chemin de la page contre la montre
...
private:
    std::string _page;// PATH de la page
