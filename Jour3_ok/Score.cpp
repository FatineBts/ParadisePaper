...
void Score::resultat(Reponses reponse, Entrainement entrainement, ContreLaMontre clm,int numero_question, int mode, std::string touche) // en fonction de si la personne donne la bonne réponse ou pas
{
    // fait appel à la réponse faite par l'utilisateur 
    std::string reponse_faite=reponse.recuperation_reponses(entrainement,clm,numero_question,mode);
