        ...
        switch (e.type)
        {
                ...
                switch (e.key.keysym.sym)
            {
                ...
                case SDLK_DOWN: //pour voir son score
                    if(i==11 && etat_courant==1) // si on est arrivés à la fin (i=11) et qu'on est en mode entrainement
                    {
                    ...
                    if(i==11 && etat_courant==2) // si on est arrivés à la fin et qu'on est en mode contre la montre
                    {
