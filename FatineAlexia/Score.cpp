...
void Score::initialisation() //va contenir les chargements d'images des différents scores possibles
{
    ...
    _images[0]= "~/FatineAlexia/IMG/0.jpg"; //pour le score de zeros
    _images[1]= "~/FatineAlexia/IMG/1.jpg";
    _images[2]= "~/FatineAlexia/IMG/2.jpg";
    _images[3]= "~/FatineAlexia/IMG/3.jpg";
    _images[4]= "~/FatineAlexia/IMG/4.jpg";
    _images[5]= "~/FatineAlexia/IMG/5.jpg";
    _images[6]= "~/FatineAlexia/IMG/6.jpg";
    _images[7]= "~/FatineAlexia/IMG/7.jpg";
    _images[8]= "~/FatineAlexia/IMG/8.jpg";
    _images[9]= "~/FatineAlexia/IMG/9.jpg";
    _images[10]= "~/FatineAlexia/IMG/10.jpg";
