...
void reset(Questions questions, Reponses reponses,Detail detail, Score score) // remet les variables à jour pour rejouer une partie 
{
    questions.mise_a_jour();
    reponses.mise_a_jour();
    detail.mise_a_jour();
    score.mise_a_jour();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        
    {
        ...
        switch (e.type)
        {
                ...
                switch (e.key.keysym.sym)
            {
                ...
                case SDLK_a: // si il repond A au QCM
                    ...
                    {
                        score.resultat(partie_contrelamontre.get_nombre(j-1),2,"A",j);
                    }
                    break;
                ...
                case SDLK_d: // si appuie sur D, il demande les détails
                    ...
                    else if(etat_courant==2) // si on est en contre la montre
                    {
                        ...
                        img = IMG_LoadTexture(renderer,detail.get_detail(partie_contrelamontre.get_nombre(j-1)).c_str()); // charge l'image
                        SDL_QueryTexture(img, NULL, NULL, &w, &h); // recuperer la longueur et largeur
                ...
                case SDLK_RIGHT: // si on appuie sur la flèche de droite, on passe à la question suivante
                    ...
                    else if(etat_courant==2) // si on est en contre la montre
                    {
                        ...
                        //std::cout << "truc" << partie_contrelamontre.get_nombre(j) << std::endl;
        ...
        //reset(questions,reponses,detail,score); // tant qu'on quitte pas, on reset
    } // fin du while(!quit)
